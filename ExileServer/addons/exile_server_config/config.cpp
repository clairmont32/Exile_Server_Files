...
class CfgSettings
{
	...
	class Weather
	{
		...
		*/
		...
		keyframes[] = {"Sunny", "Sunny", "Sunny", "Sunny_Windy", "Sunny_Windy", "Slightly_Cloudy", "Slightly_Cloudy", "Cloudy", "Rain", "Thunderstorm", "Stormy_No_Lightning", "Rain"}; 
