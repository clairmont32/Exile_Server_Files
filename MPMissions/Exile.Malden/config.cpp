...
class CfgExileEnvironment
{
	...
	class Malden: Altis
	{
		...
		class Temperature: Temperature
		{
			daytimeTemperature[] = {14.93,16.89,18.42,20.40,22.68,25.10,27.48,29.63,31.40,32.66,33.32,33.80,33.80,34.32,34.66,35.40,28.63,27.48,25.10,22.68,20.40,18.42,16.89,15.93,15.93};
